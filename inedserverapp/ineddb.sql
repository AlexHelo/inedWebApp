...
CREATE TABLE `cat_calles` (
  ...
  `co_id` int(6) DEFAULT NULL COMMENT 'ID de la colonia a que pertenece',
  `ca_tipovial` int(4) DEFAULT NULL COMMENT 'ID del tipo de vialidad a que pertenece',
...
CREATE TABLE `cat_colonias` (
  ...
  `co_tipoasen` int(2) DEFAULT NULL COMMENT 'ID del tipo de asentamiento',
  `co_asentamiento` varchar(40) DEFAULT NULL COMMENT 'Nombre de la colonia',
  `co_cp` varchar(6) DEFAULT NULL COMMENT 'Codigo postal',
  `co_del` int(4) DEFAULT NULL COMMENT 'ID de la delegación a que pertenece',
...
CREATE TABLE `cat_delegaciones` (
  ...
  `dl_cpini` int(2) DEFAULT NULL,
  `dl_utini` int(2) DEFAULT NULL,
  PRIMARY KEY (`dl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_programas` (
  ...
  `pg_subid` int(2) DEFAULT NULL COMMENT 'Subid programa',
...
CREATE TABLE `cat_sepomex` (
  ...
  `sp_delegacion` int(2) DEFAULT NULL COMMENT 'ID de delegacion',
  `sp_cp` varchar(6) DEFAULT NULL COMMENT 'Codigo postal',
  `sp_idasentamiento` int(4) DEFAULT NULL COMMENT 'ID de asentamiento',
  `sp_tipoasen` int(2) DEFAULT NULL COMMENT 'Tipo de asentamiento',
  `sp_asentamiento` varchar(100) DEFAULT NULL COMMENT 'Nombre del asentamiento',
  `sp_tipovial` int(2) DEFAULT NULL COMMENT 'Tipo de vialidad',
  `sp_vialidad` varchar(100) DEFAULT NULL COMMENT 'Nombre de la vialidad',
  `sp_noext` int(6) DEFAULT NULL,
  `sp_int` int(4) DEFAULT NULL,
  `sp_noceros` int(2) DEFAULT NULL,
  `sp_nosn` int(2) DEFAULT NULL,
...
CREATE TABLE `cat_status` (
  ...
  `st_tipostatus` int(2) DEFAULT NULL,
...
CREATE TABLE `cat_tipodocumento` (
  ...
  `dc_rq_id` int(4) DEFAULT NULL COMMENT 'ID tipo de requisito',
...
CREATE TABLE `cat_tiporequisito` (
  ...
  `rq_obligado` int(2) DEFAULT NULL,
  PRIMARY KEY (`rq_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cat_tipovialidad` VALUES (1,'Teléfono de Casa','Teléfono Casa','Tel. Casa','casa',NULL,'0',NULL,'0'),(2,'Teléfono de Oficina','Teléfono Oficina','Tel. Of','Of.',NULL,'0',NULL,'0'),(3,'Teléfono Celular','Teléfono Celular','Tel. Cel','Cel.',NULL,'0',NULL,'0');
...
CREATE TABLE `cat_ut` (
  ...
  `ut_delegacion` int(2) DEFAULT NULL COMMENT 'ID de delegación',
  PRIMARY KEY (`ut_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ds00_globales` (
  `glob_sesion_timeout` int(8) DEFAULT NULL,
  `glob_num_homo_list` int(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ds01_usuarios` (
  ...
  `b01_us_password` int(8) DEFAULT NULL COMMENT 'Password del usuario',
...
CREATE TABLE `ds02_personas` (
  ...
  `Sexo` int(2) DEFAULT NULL COMMENT 'ID_Sexo',
  `Status` int(4) DEFAULT NULL COMMENT 'ID Estatus en el padron',
  `StatusArchivo` int(4) DEFAULT NULL COMMENT 'Estatus en el archivo',
  `Folio_solicitud` int(8) DEFAULT NULL COMMENT 'Folio de solicitud',
  ...
  `Edad` int(4) DEFAULT NULL COMMENT 'Edad de la persona',
  `Domicilio_Principal` varchar(100) DEFAULT NULL COMMENT 'Contiene el domicilio actual',
  `Tipo_Vialidad` int(2) DEFAULT NULL COMMENT 'Tipo de vialidad (numerico)',
  ...
  `Delegacion` int(2) DEFAULT NULL COMMENT 'Numero de delegacion',
  `Tipo_Asentamiento` int(2) DEFAULT NULL COMMENT 'Tipo de asentamiento (numerico)',
  `Asentamiento` varchar(40) DEFAULT NULL COMMENT 'Nombre del asentamiento',
  `Tipo_Telefono` int(2) DEFAULT NULL COMMENT 'Tipo de telefono',
  `Telefono` varchar(13) DEFAULT NULL COMMENT 'Numero telefonico',
  `Regimen_Hab` int(4) DEFAULT NULL COMMENT 'Tipo de regimen (numerico)',
  `Regimen` varchar(25) DEFAULT NULL COMMENT 'Nombre del regimen',
  `Unidad_Territorial` varchar(10) DEFAULT NULL COMMENT 'UT',
  `Cve_Inegi` int(4) DEFAULT NULL COMMENT 'Clave Inegi',
  `No_Convenio` int(10) DEFAULT NULL COMMENT 'Numero de convenio',
  `Banco` int(2) DEFAULT NULL COMMENT 'Tipo de banco',
  ...
  `Asen_Id` int(6) DEFAULT NULL COMMENT 'ID Asentamiento',
  `Programa` int(4) DEFAULT NULL COMMENT 'ID de programa',
  `Subprograma` int(4) DEFAULT NULL COMMENT 'Tipo de subprograma',
  `Observaciones` varchar(60) DEFAULT NULL COMMENT 'Observaciones sobre el beneficiario',
  `SoundexNombre` int(10) DEFAULT NULL,
  `SoundexApePat` int(10) DEFAULT NULL,
  `SoundexApeMat` int(10) DEFAULT NULL,
...
CREATE TABLE `ds03_domicilios` (
  ...
  `do_Persona` int(8) DEFAULT NULL COMMENT 'ID de la persona',
  `do_Fecha_Firma_Carta` date DEFAULT NULL COMMENT 'Fecha de la firma de carta',
  `do_Numdom` int(4) DEFAULT NULL COMMENT 'Numero de domicilio',
  `do_Status` int(2) DEFAULT NULL COMMENT 'Estatus del domicilio',
  `do_Completo` varchar(100) DEFAULT NULL COMMENT 'Domicilio completo',
  `do_Tipo_Vialidad` int(2) DEFAULT NULL COMMENT 'Tipo de vialidad',
  ...
  `do_Delegacion` int(2) DEFAULT NULL COMMENT 'Numero de delegacion',
  `do_Asen_Id` int(6) DEFAULT NULL,
  `do_Tipo_Asentamiento` int(2) DEFAULT NULL COMMENT 'Tipo de asentamiento',
  `do_Asentamiento` varchar(100) DEFAULT NULL COMMENT 'Nombre del asentamiento',
  `do_Tipo_Telefono` int(2) DEFAULT NULL COMMENT 'Tipo de telefono',
  `do_Telefono` varchar(13) DEFAULT NULL COMMENT 'numero telefonico',
  `do_Regimen_Hab` int(4) DEFAULT NULL COMMENT 'ID de regimen',
  ...
  `do_Cve_Inegi` int(4) DEFAULT NULL COMMENT 'Clave inegi',
...
CREATE TABLE `ds04_programas` (
  ...
  `po_persona` int(8) DEFAULT NULL COMMENT 'ID del beneficiario',
  `po_tipo` int(4) DEFAULT NULL COMMENT 'ID Tipo',
  `po_subtipo` int(4) DEFAULT NULL COMMENT 'ID Subtipo',
  `po_folio` varchar(12) DEFAULT NULL COMMENT 'Folio',
  `po_status` int(4) DEFAULT NULL COMMENT 'Estatus',
  `po_periodicidad` int(2) DEFAULT NULL COMMENT 'ID Tipo periodicidad',
  `po_tipopago` int(2) DEFAULT NULL COMMENT 'ID Tipo de pago',
  `po_banco` int(2) DEFAULT NULL,
  `po_tipocta` int(4) DEFAULT NULL COMMENT 'ID Tipocta',
  `po_ctabanco` bigint(16) DEFAULT NULL,
  `po_importe` int(6) DEFAULT NULL COMMENT 'ID Importe',
...
CREATE TABLE `ds05_relper` (
  ...
  `rl_programa` int(10) DEFAULT NULL COMMENT 'ID programa',
  `rl_persona_titular` int(8) DEFAULT NULL COMMENT 'ID de persona titular',
  `rl_persona_rel` int(8) DEFAULT NULL COMMENT 'ID tipo de relacion',
  `rl_status` int(2) DEFAULT NULL COMMENT 'ID estatus',
  `rl_parentesco` int(2) DEFAULT NULL COMMENT 'ID parentesco',
  `rl_porcentaje` int(4) DEFAULT NULL,
  ...
  `rl_tiporelacion` int(2) DEFAULT NULL COMMENT 'ID tipo de relacion',
  PRIMARY KEY (`rl_id`),
...
CREATE TABLE `ds06_personas` (
  ...
  `per_Soundex` int(10) DEFAULT NULL,
  `per_Soundex_Nombre` int(10) DEFAULT NULL,
  `per_Soundex_Apepat` int(10) DEFAULT NULL,
  `per_Soundex_Apemat` int(10) DEFAULT NULL,
  `per_Fecha_Nacimiento` date DEFAULT NULL COMMENT 'Fecha de nacimiento del beneficiario',
  `per_Edad` int(4) DEFAULT NULL COMMENT 'Edad del beneficiario',
  ...
  `per_Sexo` int(2) DEFAULT NULL COMMENT 'ID de Sexo (numerico)',
  `per_Status` int(4) DEFAULT NULL COMMENT 'Estatus del beneficiario',
  `per_Domprincipal` int(4) DEFAULT NULL COMMENT 'Domicilio principal (ID)',
  ...
  `idds02` int(7) DEFAULT NULL COMMENT 'ID de ds02_personas',
  `Idp` int(7) DEFAULT NULL,
...
CREATE TABLE `ds07_documentos` (
  ...
  `doc_persona` int(10) DEFAULT NULL COMMENT 'ID de la persona',
  `doc_programa` int(10) DEFAULT NULL COMMENT 'ID del programa',
  `doc_tipodoc` int(4) DEFAULT NULL COMMENT 'ID tipo de documento',
  `doc_tiporeq` int(4) DEFAULT NULL COMMENT 'ID tipo de requisito',
  `doc_status` int(4) DEFAULT NULL COMMENT 'tipo del status',
  `doc_vigencia` int(2) DEFAULT NULL COMMENT 'tipo de vigencia',
...
CREATE TABLE `ds09_domicilios` (
  ...
  `do_persona` int(8) DEFAULT NULL COMMENT 'ID de la persona',
  `do_numdom` int(4) DEFAULT NULL COMMENT 'Numero de domicilio',
  `do_status` int(2) DEFAULT NULL COMMENT 'ID del estatus',
  `do_completo` varchar(100) DEFAULT NULL COMMENT 'Nombre completo',
  `do_tipo_vialidad` int(2) DEFAULT NULL COMMENT 'ID tipo de vialidad',
  `do_vialidad` varchar(40) DEFAULT NULL COMMENT 'Nombre de la vialidad',
  `do_no_exterior` int(6) DEFAULT NULL COMMENT 'Numero exterior',
  `do_no_interior` int(6) DEFAULT NULL COMMENT 'Numero interior',
  `do_localizacion` varchar(40) DEFAULT NULL,
  `do_codigo_postal` varchar(5) DEFAULT NULL COMMENT 'Codigo postal',
  `do_delegacion` int(2) DEFAULT NULL COMMENT 'ID de la delegacion',
  `do_asen_id` int(6) DEFAULT NULL COMMENT 'ID de asentamiento',
  `do_tipo_asentamiento` int(2) DEFAULT NULL COMMENT 'ID tipo de asentamiento',
  `do_asentamiento` varchar(40) DEFAULT NULL COMMENT 'Nombre del asentamiento',
  `do_tipo_telefono` int(2) DEFAULT NULL COMMENT 'ID tipo de telefono',
  `do_telefono` int(10) DEFAULT NULL COMMENT 'Numero telefono',
  `do_regimen_hab` int(4) DEFAULT NULL COMMENT 'ID del regimen',
...
CREATE TABLE `ds20_pagos` (
  ...
  `pago_persona` int(8) DEFAULT NULL,
  `pago_ano` year(4) DEFAULT NULL,
  `pago_acumulado` int(10) DEFAULT NULL,
  `pago_mes1` int(8) DEFAULT NULL,
  `pago_status1` int(2) DEFAULT NULL,
  `pago_mes2` int(8) DEFAULT NULL,
  `pago_status2` int(2) DEFAULT NULL,
  `pago_mes3` int(8) DEFAULT NULL,
  `pago_status3` int(2) DEFAULT NULL,
  `pago_mes4` int(8) DEFAULT NULL,
  `pago_status4` int(2) DEFAULT NULL,
  `pago_mes5` int(8) DEFAULT NULL,
  `pago_status5` int(2) DEFAULT NULL,
  `pago_mes6` int(8) DEFAULT NULL,
  `pago_status6` int(2) DEFAULT NULL,
  `pago_mes7` int(8) DEFAULT NULL,
  `pago_status7` int(2) DEFAULT NULL,
  `pago_mes8` int(8) DEFAULT NULL,
  `pago_status8` int(2) DEFAULT NULL,
  `pago_mes9` int(8) DEFAULT NULL,
  `pago_status9` int(2) DEFAULT NULL,
  `pago_mes10` int(8) DEFAULT NULL,
  `pago_status10` int(2) DEFAULT NULL,
  `pago_mes11` int(8) DEFAULT NULL,
  `pago_status11` int(2) DEFAULT NULL,
  `pago_mes12` int(8) DEFAULT NULL,
  `pago_status12` int(2) DEFAULT NULL,
  `pago_mesx1` int(8) DEFAULT NULL,
  `pago_corrx1` int(2) DEFAULT NULL,
  `pago_statusx1` int(2) DEFAULT NULL,
  `pago_mesx2` int(8) DEFAULT NULL,
  `pago_corrx2` int(2) DEFAULT NULL,
  `pago_statusx2` int(2) DEFAULT NULL,
  `pago_mesx3` int(8) DEFAULT NULL,
  `pago_corrx3` int(2) DEFAULT NULL,
  `pago_statusx3` int(2) DEFAULT NULL,
  `pago_mesx4` int(8) DEFAULT NULL,
  `pago_corrx4` int(2) DEFAULT NULL,
  `pago_statusx4` int(2) DEFAULT NULL,
  `pago_mesx5` int(8) DEFAULT NULL,
  `pago_corrx5` int(2) DEFAULT NULL,
  `pago_statusx5` int(2) DEFAULT NULL,
  `pago_mesx6` int(8) DEFAULT NULL,
  `pago_corrx6` int(2) DEFAULT NULL,
  `pago_statusx6` int(2) DEFAULT NULL,
