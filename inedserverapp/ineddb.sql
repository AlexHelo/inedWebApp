...
CREATE TABLE `cat_calles` (
  ...
  `co_id` int NOT NULL COMMENT 'ID de la colonia a que pertenece',
  `ca_tipovial` int NOT NULL COMMENT 'ID del tipo de vialidad a que pertenece',
...
CREATE TABLE `cat_colonias` (
  ...
  `co_tipoasen` int NOT NULL COMMENT 'ID del tipo de asentamiento',
  `co_asentamiento` varchar(40) NOT NULL COMMENT 'Nombre de la colonia',
  `co_cp` varchar(6) NOT NULL COMMENT 'Codigo postal',
  `co_del` int NOT NULL COMMENT 'ID de la delegación a que pertenece',
...
CREATE TABLE `cat_delegaciones` (
  ...
  `dl_cpini` int NOT NULL,
  `dl_utini` int NOT NULL,
  PRIMARY KEY (`dl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_programas` (
  ...
  `pg_subid` int NOT NULL COMMENT 'Subid programa',
...
CREATE TABLE `cat_sepomex` (
  ...
  `sp_delegacion` int NOT NULL COMMENT 'ID de delegacion',
  `sp_cp` varchar(6) NOT NULL COMMENT 'Codigo postal',
  `sp_idasentamiento` int NOT NULL COMMENT 'ID de asentamiento',
  `sp_tipoasen` int NOT NULL COMMENT 'Tipo de asentamiento',
  `sp_asentamiento` varchar(100) NOT NULL COMMENT 'Nombre del asentamiento',
  `sp_tipovial` int NOT NULL COMMENT 'Tipo de vialidad',
  `sp_vialidad` varchar(100) NOT NULL COMMENT 'Nombre de la vialidad',
  `sp_noext` int NOT NULL,
  `sp_int` int NOT NULL,
  `sp_noceros` int NOT NULL,
  `sp_nosn` int NOT NULL,
...
CREATE TABLE `cat_tipodocumento` (
  ...
  `dc_rq_id` int NOT NULL COMMENT 'ID tipo de requisito',
...
CREATE TABLE `cat_ut` (
  ...
  `ut_delegacion` int NOT NULL COMMENT 'ID de delegación',
  PRIMARY KEY (`ut_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ds00_globales` (
  `glob_sesion_timeout` int NOT NULL,
  `glob_num_homo_list` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ds01_usuarios` (
  ...
  `b01_us_password` int NOT NULL COMMENT 'Password del usuario',
...
INSERT INTO `ds01_usuarios` VALUES (1,'octa','luna','mixbox',12345,'2020-06-01','2020-06-02','operador1',52345678,10,1,1,1,1,'role1'),(2,'gustavo','sol','mixbos',14123,'2020-07-01','2020-07-02','operador2',2345678,11,2,2,2,2,'role2'),(3,'eric','chao','mixboz',19842,'2020-08-01','2020-08-02','operador3',7,12,3,3,3,3,'role3'),(4,'Simon','Key Yeah','Simonkey',123,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Monitor'),(5,'Jose','Berron Gutierrez','JoseB',12,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Monitor'),(6,'Mario','Jim Jim','Jim',32,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Administrador'),(7,'Alex','Syntek Syntek','Buenas',34,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Administrador'),(8,'Ignacio','Alvarado King','Nacho',45,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Administrador'),(9,'Pedro','Pica Piedra','PicaPiedra',12,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Administrador'),(10,'Korean','Korean Korean','Korean',123,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Administrador');
...
CREATE TABLE `ds02_personas` (
  ...
  `Sexo` int NOT NULL COMMENT 'ID_Sexo',
  `Status` int NOT NULL COMMENT 'ID Estatus en el padron',
  `StatusArchivo` int NOT NULL COMMENT 'Estatus en el archivo',
  `Folio_solicitud` int NOT NULL COMMENT 'Folio de solicitud',
  ...
  `Edad` int NOT NULL COMMENT 'Edad de la persona',
  `Domicilio_Principal` varchar(100) NOT NULL COMMENT 'Contiene el domicilio actual',
  `Tipo_Vialidad` int NOT NULL COMMENT 'Tipo de vialidad (numerico)',
  ...
  `Delegacion` int NOT NULL COMMENT 'Numero de delegacion',
  `Tipo_Asentamiento` int NOT NULL COMMENT 'Tipo de asentamiento (numerico)',
  `Asentamiento` varchar(40) NOT NULL COMMENT 'Nombre del asentamiento',
  `Tipo_Telefono` int NOT NULL COMMENT 'Tipo de telefono',
  `Telefono` varchar(13) NOT NULL COMMENT 'Numero telefonico',
  `Regimen_Hab` int NOT NULL COMMENT 'Tipo de regimen (numerico)',
  `Regimen` varchar(25) NOT NULL COMMENT 'Nombre del regimen',
  `Unidad_Territorial` varchar(10) NOT NULL COMMENT 'UT',
  `Cve_Inegi` int NOT NULL COMMENT 'Clave Inegi',
  `No_Convenio` int NOT NULL COMMENT 'Numero de convenio',
  `Banco` int NOT NULL COMMENT 'Tipo de banco',
  ...
  `Asen_Id` int NOT NULL COMMENT 'ID Asentamiento',
  `Programa` int NOT NULL COMMENT 'ID de programa',
  `Subprograma` int NOT NULL COMMENT 'Tipo de subprograma',
  `Observaciones` varchar(60) NOT NULL COMMENT 'Observaciones sobre el beneficiario',
  `SoundexNombre` int NOT NULL,
  `SoundexApePat` int NOT NULL,
  `SoundexApeMat` int NOT NULL,
...
CREATE TABLE `ds03_domicilios` (
  ...
  `do_Persona` int NOT NULL COMMENT 'ID de la persona',
  `do_Fecha_Firma_Carta` date NOT NULL COMMENT 'Fecha de la firma de carta',
  `do_Numdom` int NOT NULL COMMENT 'Numero de domicilio',
  `do_Status` int NOT NULL COMMENT 'Estatus del domicilio',
  `do_Completo` varchar(100) NOT NULL COMMENT 'Domicilio completo',
  `do_Tipo_Vialidad` int NOT NULL COMMENT 'Tipo de vialidad',
  ...
  `do_Delegacion` int NOT NULL COMMENT 'Numero de delegacion',
  `do_Asen_Id` int NOT NULL,
  `do_Tipo_Asentamiento` int NOT NULL COMMENT 'Tipo de asentamiento',
  `do_Asentamiento` varchar(100) NOT NULL COMMENT 'Nombre del asentamiento',
  `do_Tipo_Telefono` int NOT NULL COMMENT 'Tipo de telefono',
  `do_Telefono` varchar(13) NOT NULL COMMENT 'numero telefonico',
  `do_Regimen_Hab` int NOT NULL COMMENT 'ID de regimen',
  ...
  `do_Cve_Inegi` int NOT NULL COMMENT 'Clave inegi',
...
CREATE TABLE `ds04_programas` (
  ...
  `po_persona` int NOT NULL COMMENT 'ID del beneficiario',
  `po_tipo` int NOT NULL COMMENT 'ID Tipo',
  `po_subtipo` int NOT NULL COMMENT 'ID Subtipo',
  `po_folio` varchar(12) NOT NULL COMMENT 'Folio',
  `po_status` int NOT NULL COMMENT 'Estatus',
  `po_periodicidad` int NOT NULL COMMENT 'ID Tipo periodicidad',
  `po_tipopago` int NOT NULL COMMENT 'ID Tipo de pago',
  `po_banco` int NOT NULL,
  `po_tipocta` int NOT NULL COMMENT 'ID Tipocta',
  `po_ctabanco` bigint NOT NULL,
  `po_importe` int NOT NULL COMMENT 'ID Importe',
...
CREATE TABLE `ds05_relper` (
  ...
  `rl_programa` int NOT NULL COMMENT 'ID programa',
  `rl_persona_titular` int NOT NULL COMMENT 'ID de persona titular',
  `rl_persona_rel` int NOT NULL COMMENT 'ID tipo de relacion',
  `rl_status` int NOT NULL COMMENT 'ID estatus',
  `rl_parentesco` int NOT NULL COMMENT 'ID parentesco',
  `rl_porcentaje` int NOT NULL,
  ...
  `rl_tiporelacion` int NOT NULL COMMENT 'ID tipo de relacion',
  PRIMARY KEY (`rl_id`),
...
CREATE TABLE `ds06_personas` (
  ...
  `per_Soundex` int NOT NULL,
  `per_Soundex_Nombre` int NOT NULL,
  `per_Soundex_Apepat` int NOT NULL,
  `per_Soundex_Apemat` int NOT NULL,
  `per_Fecha_Nacimiento` date NOT NULL COMMENT 'Fecha de nacimiento del beneficiario',
  `per_Edad` int NOT NULL COMMENT 'Edad del beneficiario',
  ...
  `per_Sexo` int NOT NULL COMMENT 'ID de Sexo (numerico)',
  `per_Status` int NOT NULL COMMENT 'Estatus del beneficiario',
  `per_Domprincipal` int NOT NULL COMMENT 'Domicilio principal (ID)',
  ...
  `idds02` int NOT NULL COMMENT 'ID de ds02_personas',
  `Idp` int NOT NULL,
...
CREATE TABLE `ds07_documentos` (
  ...
  `doc_persona` int NOT NULL COMMENT 'ID de la persona',
  `doc_programa` int NOT NULL COMMENT 'ID del programa',
  `doc_tipodoc` int NOT NULL COMMENT 'ID tipo de documento',
  `doc_tiporeq` int NOT NULL COMMENT 'ID tipo de requisito',
  `doc_status` int NOT NULL COMMENT 'tipo del status',
  `doc_vigencia` int NOT NULL COMMENT 'tipo de vigencia',
...
CREATE TABLE `ds09_domicilios` (
  ...
  `do_persona` int NOT NULL COMMENT 'ID de la persona',
  `do_numdom` int NOT NULL COMMENT 'Numero de domicilio',
  `do_status` int NOT NULL COMMENT 'ID del estatus',
  `do_completo` varchar(100) NOT NULL COMMENT 'Nombre completo',
  `do_tipo_vialidad` int NOT NULL COMMENT 'ID tipo de vialidad',
  `do_vialidad` varchar(40) NOT NULL COMMENT 'Nombre de la vialidad',
  `do_no_exterior` int NOT NULL COMMENT 'Numero exterior',
  `do_no_interior` int NOT NULL COMMENT 'Numero interior',
  `do_localizacion` varchar(40) NOT NULL,
  `do_codigo_postal` varchar(5) NOT NULL COMMENT 'Codigo postal',
  `do_delegacion` int NOT NULL COMMENT 'ID de la delegacion',
  `do_asen_id` int NOT NULL COMMENT 'ID de asentamiento',
  `do_tipo_asentamiento` int NOT NULL COMMENT 'ID tipo de asentamiento',
  `do_asentamiento` varchar(40) NOT NULL COMMENT 'Nombre del asentamiento',
  `do_tipo_telefono` int NOT NULL COMMENT 'ID tipo de telefono',
  `do_telefono` int NOT NULL COMMENT 'Numero telefono',
  `do_regimen_hab` int NOT NULL COMMENT 'ID del regimen',
...
CREATE TABLE `ds20_pagos` (
  ...
  `pago_persona` int NOT NULL,
  `pago_ano` year NOT NULL,
  `pago_acumulado` int NOT NULL,
  `pago_mes1` int NOT NULL,
  `pago_status1` int NOT NULL,
  `pago_mes2` int NOT NULL,
  `pago_status2` int NOT NULL,
  `pago_mes3` int NOT NULL,
  `pago_status3` int NOT NULL,
  `pago_mes4` int NOT NULL,
  `pago_status4` int NOT NULL,
  `pago_mes5` int NOT NULL,
  `pago_status5` int NOT NULL,
  `pago_mes6` int NOT NULL,
  `pago_status6` int NOT NULL,
  `pago_mes7` int NOT NULL,
  `pago_status7` int NOT NULL,
  `pago_mes8` int NOT NULL,
  `pago_status8` int NOT NULL,
  `pago_mes9` int NOT NULL,
  `pago_status9` int NOT NULL,
  `pago_mes10` int NOT NULL,
  `pago_status10` int NOT NULL,
  `pago_mes11` int NOT NULL,
  `pago_status11` int NOT NULL,
  `pago_mes12` int NOT NULL,
  `pago_status12` int NOT NULL,
  `pago_mesx1` int NOT NULL,
  `pago_corrx1` int NOT NULL,
  `pago_statusx1` int NOT NULL,
  `pago_mesx2` int NOT NULL,
  `pago_corrx2` int NOT NULL,
  `pago_statusx2` int NOT NULL,
  `pago_mesx3` int NOT NULL,
  `pago_corrx3` int NOT NULL,
  `pago_statusx3` int NOT NULL,
  `pago_mesx4` int NOT NULL,
  `pago_corrx4` int NOT NULL,
  `pago_statusx4` int NOT NULL,
  `pago_mesx5` int NOT NULL,
  `pago_corrx5` int NOT NULL,
  `pago_statusx5` int NOT NULL,
  `pago_mesx6` int NOT NULL,
  `pago_corrx6` int NOT NULL,
  `pago_statusx6` int NOT NULL,
...
-- Dump completed on 2020-11-09 19:30:06
