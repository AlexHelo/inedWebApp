...
const AceptAdultForm = () => {
    ...
    const body = (
        <div style={modalStyle} className={classes.paper}>
            ...
            <FormLine>
                <Button to="/AdminBuscar" onClick={() => { UploadData(); handleClose(); history.push("/AdminBuscar"); }} variant="contained" color="primary" >Agregar Solicitud</Button>
